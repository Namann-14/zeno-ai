...
import { LoaderFive, LoaderFour, LoaderThree, LoaderTwo } from "@/components/ui/loader";
                        ...
                        {conversations.results?.map((conversation) => {
                            ...
                            return (
                                ...
                                >
                                    <div
                                        className={cn(
                                            "translate-y-1/2 absolute -top-1/6 left-0 h-[64%] w-1 rounded-r-full bg-neutral-300 transition-opacity",
                                            pathname === `/conversations/${conversation._id}` &&
                                            "bg-accent text-accent-foreground" &&
                                            "opacity-100"
                                        )}
...
export const SkeletonConversation = () => {
    return (
        <div className="flex min-h-fit flex-1 gap-2 overflow-auto">
